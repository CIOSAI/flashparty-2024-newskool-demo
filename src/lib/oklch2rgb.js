...
const oklch2rgb = lch => {
  // modified to the order of hue sat bri
  // and input range to 0-1
  let okSoThisIsIn256_likeAreYouFR = srgbLinear2rgb(xyz2rgbLinear(oklab2xyz(oklch2oklab(
    [lch[2]*360, lch[1]*0.4, lch[0]]))));
  return [okSoThisIsIn256_likeAreYouFR[0]/256, okSoThisIsIn256_likeAreYouFR[1]/256, okSoThisIsIn256_likeAreYouFR[2]/256];
}
const rgb2oklch = rgb =>
